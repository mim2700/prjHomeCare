...
public class FacilityBO {
	...
	private	String	inspectionVisit;
	...
	public String getInspectionVisit() {
		return inspectionVisit;
	}
	public void setInspectionVisit(String inspectionVisit) {
	...
	public String getSemiPrivate() {
		return semiPrivate;
	}
	public void setSemiPrivate(String semiPrivate) {
